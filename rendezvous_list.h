#ifndef __RENDEZVOUS_LIST__
#define __RENDEZVOUS_LIST__

namespace rendezvous
{


// Lockfree list specialized for rendezvous needs
namespace list
{
...
public:
    ...
    void SetAtomic(BWH BusyWaitHandler, CASF CAS, List& l)
    {
        T* t = l.tail;
        head = l.head;
        int loopCount = 0;
    ...
    template<typename BWH, typename CASF>
    List AcquireAtomic(BWH BusyWaitHandler, CASF CAS)
    {
        List l;
        if(tail)
        {
    ...
    template<typename BWH, typename CASF>
    void AddAtomic(BWH BusyWaitHandler, CASF CAS, T& elt)
    {
        ...
        while(true)
        {
            ...
            {
                // Somewhat complicated beacause of possibility of getting AcquireAtomic here
                // so tail may suddenly become nullptr
